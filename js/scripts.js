...
function togleClass() {
	...
	const billintItems = document.querySelectorAll('.pricing__billing-item')

	switcher.addEventListener('click', () => {
		switcher.classList.toggle('active')

		if (!switcher.classList.contains('active')) {
				billintItems[0].classList.add('active')
				billintItems[2].classList.remove('active')
		} else {
			billintItems[0].classList.remove('active')
			billintItems[2].classList.add('active')
		}
	})
}
togleClass()
